...
namespace UnityQuickSheet
{
    ...
    public class GoogleDataSettings : ScriptableObject
    {
        ...
        {
			string filePath = QuickSheet.CustomAssetUtility.GetUniqueAssetPathNameOrFallback(AssetFileName);
            ...
            if (s_Instance == null)
            {
				...
				string path = QuickSheet.CustomAssetUtility.GetUniqueAssetPathNameOrFallback(AssetFileName);
