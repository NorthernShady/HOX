...
namespace UnityQuickSheet
{
    internal class ScriptGenerator
    {
		...
		private string WorkSheetName
		{
			get
			{
				if (!string.IsNullOrEmpty(m_ScriptPrescription.worksheetName))
					return m_ScriptPrescription.worksheetName;
				return "Error_Empty_WorkSheet_Name";
			}
		}
        ...
        public override string ToString ()
        {
			...
			m_Text = m_Text.Replace ("$WorkSheetName", WorkSheetName);
