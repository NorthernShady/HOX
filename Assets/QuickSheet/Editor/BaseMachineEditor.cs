...
namespace UnityQuickSheet
{
    ...
    public class BaseMachineEditor : Editor
    {
        ...
        protected void CreateScriptableObjectClassScript(BaseMachine machine, ScriptPrescription sp)
        {
			...
			sp.className = machine.WorkSheetName + "Representation";
        ...
        protected void CreateDataClassScript(BaseMachine machine, ScriptPrescription sp)
        {
			...
			sp.worksheetName = machine.WorkSheetName;
			sp.className = machine.WorkSheetName + "Representation" + "Data";
        ...
        {
			return Path.Combine("Assets/" + machine.RuntimeClassPath, worksheetName + "Representation" + "." + "cs");
        }
        ...
        {
			return Path.Combine("Assets/" + machine.EditorClassPath, worksheetName + "Representation" + "Editor" + "." + "cs");
        }
        ...
        {
			return Path.Combine("Assets/" + machine.RuntimeClassPath, worksheetName + "Representation" + "Data" + "." + "cs");
        }
        ...
        {
			return Path.Combine("Assets/" + machine.EditorClassPath, worksheetName + "Representation" + "AssetCreator" + "." + "cs");
        }
        ...
        {
			return Path.Combine("Assets/" + machine.EditorClassPath, worksheetName + "Representation" + "AssetPostProcessor" + "." + "cs");
        }
