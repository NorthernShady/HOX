...
/// 
[System.Serializable]
public class LevelListRepresentation : BaseScriptableObject<LevelListRepresentationData> 
{   
    void OnEnable()
    {
//#if UNITY_EDITOR
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new LevelListRepresentationData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public LevelListRepresentationData FindByKey(string key)
    //{
