...
/// 
[System.Serializable]
public class InAppItemRepresentation : BaseScriptableObject<InAppItemRepresentationData> 
{   
    void OnEnable()
    {
//#if UNITY_EDITOR
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new InAppItemRepresentationData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public InAppItemRepresentationData FindByKey(string key)
    //{
