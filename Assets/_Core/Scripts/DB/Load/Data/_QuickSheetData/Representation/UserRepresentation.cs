...
/// 
[System.Serializable]
public class UserRepresentation : BaseScriptableObject<UserRepresentationData> 
{   
    void OnEnable()
    {
//#if UNITY_EDITOR
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new UserRepresentationData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public UserRepresentationData FindByKey(string key)
    //{
