...
/// 
[System.Serializable]
public class CharacterNormRepresentation : BaseScriptableObject<CharacterNormRepresentationData> 
{   
    void OnEnable()
    {
//#if UNITY_EDITOR
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new CharacterNormRepresentationData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public CharacterNormRepresentationData FindByKey(string key)
    //{
