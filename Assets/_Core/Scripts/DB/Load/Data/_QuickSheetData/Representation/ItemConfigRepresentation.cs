...
/// 
[System.Serializable]
public class ItemConfigRepresentation : BaseScriptableObject<ItemConfigRepresentationData> 
{   
    void OnEnable()
    {
//#if UNITY_EDITOR
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new ItemConfigRepresentationData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public ItemConfigRepresentationData FindByKey(string key)
    //{
