...
/// 
[System.Serializable]
public class NotificationsRepresentation : BaseScriptableObject<NotificationsRepresentationData> 
{   
    void OnEnable()
    {
//#if UNITY_EDITOR
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new NotificationsRepresentationData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public NotificationsRepresentationData FindByKey(string key)
    //{
