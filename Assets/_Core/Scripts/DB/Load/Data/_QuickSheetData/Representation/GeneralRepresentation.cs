...
/// 
[System.Serializable]
public class GeneralRepresentation : BaseScriptableObject<GeneralRepresentationData> 
{   
    void OnEnable()
    {
//#if UNITY_EDITOR
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new GeneralRepresentationData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public GeneralRepresentationData FindByKey(string key)
    //{
