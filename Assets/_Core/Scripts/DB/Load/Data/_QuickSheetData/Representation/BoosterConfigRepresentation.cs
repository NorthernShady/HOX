...
/// 
[System.Serializable]
public class BoosterConfigRepresentation : BaseScriptableObject<BoosterConfigRepresentationData> 
{   
    void OnEnable()
    {
//#if UNITY_EDITOR
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new BoosterConfigRepresentationData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public BoosterConfigRepresentationData FindByKey(string key)
    //{
