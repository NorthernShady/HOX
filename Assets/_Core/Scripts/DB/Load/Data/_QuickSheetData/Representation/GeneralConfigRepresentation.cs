...
/// 
[System.Serializable]
public class GeneralConfigRepresentation : BaseScriptableObject<GeneralConfigRepresentationData> 
{   
    void OnEnable()
    {
//#if UNITY_EDITOR
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new GeneralConfigRepresentationData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public GeneralConfigRepresentationData FindByKey(string key)
    //{
